...
public class Piece implements Comparable<Piece> {
	...
	/**
	 * A {@link java.util.concurrent.Callable} to call the piece validation function.
	 *
	 * <p>
	 * This {@link java.util.concurrent.Callable} implementation allows for the calling of the piece

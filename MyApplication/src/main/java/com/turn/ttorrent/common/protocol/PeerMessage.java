...
public abstract class PeerMessage {
	...
	/**
	 * Returns a {@link java.nio.ByteBuffer} backed by the same data as this message.
	 *
	 * <p>
	 ...
	 * @throws java.text.ParseException When the message is invalid, can't be parsed or

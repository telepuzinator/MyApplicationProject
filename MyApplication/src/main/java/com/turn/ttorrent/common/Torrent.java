...
import com.turn.ttorrent.util.Logger;
import com.turn.ttorrent.util.LoggerFactory;
...
public class Torrent {
	 ...
	 * @throws java.security.NoSuchAlgorithmException If the SHA-1 algorithm is not
	 * available.
	 */
	...
	/**
	 * A {@link java.util.concurrent.Callable} to hash a data chunk.
	 *
	 * @author mpetazzoni
	 */
	 ...
	 * @param results The list of {@link java.util.concurrent.Future}s that will yield the piece
	 *	hashes.
	 */
...
//				}
//
//				String creator = String.format("%s (com.turn.ttorrent)",
